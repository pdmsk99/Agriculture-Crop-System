...
public class AddressController {
	...
	public ResponseEntity<AddressDTO> deleteProduct(@PathVariable("addressId") Integer addressId)
			throws RecordNotFoundException {
		log.info("START");
		AddressDTO addresses = service.delete(addressId);
		if (addresses == null) {
			return new ResponseEntity("Sorry! AddressId not available!", HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<AddressDTO>(addresses, HttpStatus.OK);
	}
